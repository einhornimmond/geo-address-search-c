 ...
 *  weight, its kind, the search texts, its country code, its role and the batch it
 *  arrived in.  Everything
 ...
 *  5: … and the role its entry plays, a settlement or the land it governs. */
#define PLACE_CACHE_LAYOUT 5u
